...
public final class UploadIdleGoodsInfo <K extends JComponent> extends MouseAdapter {
	private K trigger;
	
	public UploadIdleGoodsInfo(K k) {
		trigger = k;
	}
	...
	public synchronized static void doIt() {
		...
		UploadIdleGoods upload = new UploadIdleGoods();
