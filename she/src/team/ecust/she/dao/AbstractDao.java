...
public abstract class AbstractDao {
	...
	private final static String URL      = "jdbc:mysql://172.20.10.2:3306/she?characterEncoding=utf-8";
	/**服务器配置时的用户名{@value}*/
	private final static String USER     = "ljj";
	/**服务器配置时的密码{@value}*/
	private final static String PASSWORD = "10161832";
